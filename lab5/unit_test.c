...
int main(int argc, char* argv[])
{
	Status (*tests[])(char*,int)=
	{
		...
		test_my_string_compare_returns_0a,
		test_my_string_compare_returns_0b,
		test_my_string_compare_returns_0c,
		test_my_string_compare_returns_0d,
		test_my_string_compare_returns_0e,
		test_my_string_compare_returns_0f,
		test_my_string_compare_returns_0g,
		test_my_string_compare_returns_0h,
		test_my_string_compare_returns_0i,
		test_my_string_compare_returns_0j
