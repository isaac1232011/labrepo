...
Status my_string_concat(MY_STRING hResult, MY_STRING hAppend)
{
	...
	int i;
	char* temp;
	//case 1 nothing to copy
	if(str2->size==0)
	{return FAILURE;}
	//case 2:exsist string, and  str1 is empty copy data into str1
	else if(str1->size==0)
	...
	else //if str1 not empty->resize
		//make enouth space to store combined string
	{
